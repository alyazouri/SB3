// ============================================================
// PUBG JORDAN ULTIMATE ROUTING v2
// Jordan ISP Lock + IPv4 + IPv6 + Lobby/Match
// ============================================================
...
function isLobby(data){
  ...
  return /lobby|login|auth|session|gateway|queue|profile|inventory|store|shop|friends|party|team|patch|update|cdn|download/i
  .test(data);
