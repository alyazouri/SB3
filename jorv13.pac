// ================================================================
//  PUBG MOBILE – JORDAN LOCK PAC v13.0
//  هدف: أردنيين فقط – حجب دقيق لمصر / لبنان / سوريا / العراق
//  ================================================================
//  ملاحظة تقنية مهمة:
//  سوريا (AS29256) = 0 نطاق IPv6 موثّق في RIPE
//  مصر مسجّلة في AfriNIC وليس RIPE → نطاقاتها خارج 2a::/16
//  لبنان IPv6 نادر جداً – أغلب مستخدميه على IPv4
//  
//  لذلك المشكلة الرئيسية: اللاعبون من هذه الدول يدخلون
//  عبر IPv4 حين تعطي lobbyChain() نتيجة DIRECT كـ fallback
//  الحل في v13: lobbyChain() = LOBBY→ALT→BLOCK (لا DIRECT)
//  + حجب صريح لكل نطاقات IPv6 المعروفة لدول الجوار
// ================================================================
...
// ================================================================
//  IPv6 JORDAN – كامل (كل ISP أردني موثّق RIPE/IPinfo مارس 2026)
//  مُرتّب: /29 أولاً = أسرع تطابق
// ================================================================
var JO_IPV6 = [
  // Orange / Jordan Data Communications (AS8376) – أكبر ISP أردني
  "2a01:9700::/29",       // تخصيص 2023 الشامل
  "2a01:9700::/32",       // legacy prefix
  "2a01:9700:1000::/36",  // ADSL/FTTH 2022
  "2a01:9700:3900::/40",
  "2a01:9700:3920::/44",
  "2a01:9700:4850::/44",
  "2a01:9700:15a5::/48",
  ...
  // Al Mouakhah (AS42912) – ثالث أكبر ISP
  "2a04:8640::/32",
  "2a04:8640:1::/48",
  "2a04:8640:2::/48",
  "2a04:8640:3::/48",
  ...
  // VTel / DAMAMAX (AS50670) – updated Jan 2026
  "2a02:2a60::/32",
  "2a02:2a60:1::/48",
  "2a02:2a60:2::/48",
  "2a0c:b641::/32",
  ...
  // NITC / جامعات وحكومة (AS8934)
  "2a01:4f8:130::/48",

  // JO-IX / Jordan Internet Exchange
  "2001:16a0::/32",
  "2001:16a0:1::/48",
  "2a01:b740::/32"
];
...
// ================================================================
//  PUBG ME SERVERS – أقرب للأردن
//  AWS Bahrain ~35ms | AWS UAE ~40ms | Tencent ME ~45ms
// ================================================================
var PUBG_SERVERS_IPV6 = [
  "2a05:d018::/36",       // AWS Bahrain me-south-1 (AS16509)
  "2a05:d018:400::/38",
  "2a05:d018:800::/38",
  "2a05:d018:1000::/36",
  "2a05:d07c::/36",       // AWS UAE me-central-1 (AS16509)
  "2a05:d07c:2000::/40",
  "2402:4e00::/32",       // Tencent Cloud ME
  "2402:4e00:1::/48",
  "2402:4e00:2::/48",
  "2606:4700::/32",       // Cloudflare anycast (lobby/auth)
  "2803:f800::/32"
];

// ================================================================
//  BLOCKED IPv6 – دول الجوار + المحجوبة سابقاً
//  ================================================================
//  ملاحظة: سوريا (AS29256) لا تملك أي prefix IPv6 مسجّل في RIPE
//  مصر مسجّلة في AfriNIC → نطاقاتها تبدأ بـ 2001:4200::/23
//  لبنان: نطاقات نادرة جداً لكن موثّقة أدناه
// ================================================================
var BLOCKED_IPV6 = [

  // ══ مصر – AfriNIC allocation (AS8452 TE / AS36992 Etisalat) ══
  // مصر مسجّلة في AfriNIC لا RIPE، نطاقاتها:
  "2001:4200::/23",       // AfriNIC – مصر (التخصيص الرئيسي)
  "2c0f::/16",            // AfriNIC global block (Africa)
  // TE-AS (AS8452) – أكبر ISP مصري
  "2a02:4540::/32",
  "2a02:4540:1::/48",
  // Etisalat Misr (AS36992)
  "2a02:7580::/32",
  // Vodafone Egypt (AS24835 / AS36935)
  "2a02:8080::/32",
  "2a04:c540::/32",
  // Link Egypt (AS24863)
  "2a02:f680::/32",
  // Mobinil / Orange Egypt (AS37069)
  "2a06:f080::/32",

  // ══ لبنان – RIPE allocation ══
  // Ogero Telecom (AS9051) – مزود الخدمة الحكومي الرئيسي
  "2a05:b480::/32",
  "2a05:b480:1::/48",
  // Alfa Mobile (AS42020)
  "2a06:2200::/32",
  "2a06:2200:1::/48",
  // Touch Mobile Lebanon (AS30950)
  "2a05:6c80::/32",
  "2a05:6c80:1::/48",
  // LibanTelecom / IDM (AS9051 subsidiary)
  "2a06:d400::/32",

  // ══ سوريا – AS29256 = 0 IPv6 في RIPE ══
  // لكن بعض المستخدمين السوريين يصلون عبر:
  // Turk Telecom transit أو Telia - هذه محجوبة ضمن BLOCKED_GENERIC أدناه
  // لا يوجد prefix سوري IPv6 مستقل يستحق الحجب الصريح

  // ══ العراق – RIPE allocation ══
  // Earthlink (AS51684)
  "2a06:2bc0::/32",
  "2a06:2bc0:1::/48",
  // Zain Iraq (AS203214)
  ...
  // Asia Cell (AS199739)
  "2a06:2140::/32",
  // Korek Telecom (AS205178)
  "2a0d:3600::/32",
  // ITC Iraq (AS196881)
  "2a04:bec0::/32",

  // ══ السعودية – (منعاً للتوجيه غير المرغوب) ══
  // STC (AS25019)
  "2a06:d380::/32",
  // Mobily (AS35819)
  "2a04:8e40::/32",
...
//  PROXY CHAINS
//
//  v13 CHANGE – lobbyChain لا تنتهي بـ DIRECT
//  ← هذا هو السبب الجذري لدخول المصريين واللبنانيين
//  القديم: LOBBY → ALT → DIRECT  (اللاعبون غير الأردنيين يمرون DIRECT)
//  الجديد: LOBBY → ALT → BLOCK   (إذا فشل البروكسي = حجب تام)
//
//  Match : MATCH → ALT → BLOCK
//  Lobby : LOBBY → ALT → BLOCK  ← التغيير الأهم
//  CDN   : DIRECT (لا تأثير على جلب اللاعبين)
//  Social: DIRECT
// ================================================================
...
function FindProxyForURL(url,host) {
  ...
  if (isIP6(host)) {
    ...
    if (inList6(ip6,BLOCKED_IPV6))  return BLOCK;  // مصر/لبنان/عراق/إيران...
    if (!isAllowed6(ip6))           return BLOCK;  // أي شيء غير أردني
...
// ================================================================
//  END – PUBG Mobile Jordan Lock v13.0
//  أردنيين فقط | حجب مصر / لبنان / سوريا / العراق / السعودية
//  lobbyChain = LOBBY→ALT→BLOCK (لا DIRECT fallback)
// ================================================================
