// ============================================================================
// 🎮 PUBG MOBILE - JORDAN ULTRA SYSTEM v11.0 APEX
// 🇯🇴 Full ISP Coverage | All Game Modes | Android + iOS | Auto-Reconnect
// ⚡ Bitmap CIDR | O(1) Lookups | Dual-Stack | Comprehensive Patterns
// ============================================================================
...
// سلاسل إعادة الاتصال التلقائي — تنتقل للتالي عند الانقطاع
...
// ============================================================================
// 🇯🇴 JORDAN IPv4 — جميع المزودين الرئيسيين
// ============================================================================
var JO_V4 = [
...
// ============================================================================
// 🇯🇴 JORDAN IPv6 — مرتبة حسب الحجم والأولوية
// ============================================================================
var JO_V6 = [
...
// ============================================================================
// 🎯 PUBG DOMAINS — تغطية شاملة لجميع الخدمات
// ============================================================================
var DOM_CRITICAL = [
  // Matchmaking & Lobby
...
// ============================================================================
// 📡 PUBG PORTS — تغطية شاملة Android + iOS
// ============================================================================
var PUBG_PORTS = [
  // HTTPS & HTTP
...
// ============================================================================
// 🧬 PATTERNS — أنماط شاملة لجميع مودات PUBG Mobile
// ============================================================================
// regex واحدة مُجمَّعة تغطي جميع الأنماط
var PUBG_RX = new RegExp(
  ...
  // Game servers
  "game|battle|combat|play|fight|pvp|action|sync|state" +"|"+
  // All maps
  "erangel|miramar|sanhok|vikendi|livik|metro|karakin|nusa|deston" +"|"+
  // All modes
  "classic|arcade|evoground|ranked|tdm|arena|payload|beryl|" +
  "training|cheer|mission|royalepass|rp|season" +"|"+
  // Platform-specific
  "android|ios|mobile|client|gateway|relay|cdn|ws|wss" +"|"+
  // Network patterns
  "\\bgs\\b|\\bmm\\b|\\bgs[0-9]|\\bsvr|\\bsrv|realtime|live"
);

// ============================================================================
// ⚡ PRE-COMPUTED STRUCTURES (تُحسب مرة واحدة عند التحميل)
// ============================================================================
...
// Bitmask arrays — حساب مسبق لكل CIDR
var _BM_JO = (function() {
  var r=[];
...
// Fast IPv4 prefix map للنطاقات الكبيرة
var _FV4 = (function() {
  var m={};
  var p=[
    "37.123.","37.202.","176.29.","46.185.",
    "82.212.","86.108.","212.35.","212.118.",
    "213.139.","185.98.","188.247.","176.28.",
    "92.253.","212.34.","213.186."
  ];
...
function _classify(ip) {
  ...
  if (_v6(ip)) {
    ...
    if (!bl) {
      // Fast-path أولاً
      var dot=ip.indexOf(".",ip.indexOf(".")+1)+1;
      jo=(_FV4[ip.substring(0,dot)]||_bmHit(n,_BM_JO))?1:0;
    }
  }
  return (_IC[ip]={jo:jo,bl:bl});
}
...
function FindProxyForURL(url, host) {
  ...
  // ── 3. Routing ────────────────────────────────────────────────────────────
  //   أردني + حرج  → أقوى سلسلة مع إعادة اتصال كاملة
  if (cl.jo && isCritical) return CHAIN_MAX;
  //   أردني + PUBG عام
  if (cl.jo && isPubg)     return CHAIN_STRONG;
  //   حرج بدون أردني
  if (isCritical)          return CHAIN_STRONG;
  //   PUBG عام فقط
  if (isPubg)              return CHAIN_LIGHT;
  //   IP أردني فقط
  if (cl.jo)               return CHAIN_LIGHT;

  return DIRECT;
}
// ============================================================================
// ✅ v11.0 APEX | All Modes | Android+iOS | Bitmap | O(1) | Auto-Reconnect
// ============================================================================
